...
[Hide and disable all items on the desktop](javascript:void();)

Enabled

Local Group Policy

[Prohibit adjusting desktop toolbars](javascript:void();)

Enabled

Local Group Policy

[Remove the Desktop Cleanup Wizard](javascript:void();)
...
[Do not allow pinning items in Jump Lists](javascript:void();)

Enabled

Local Group Policy

[Do not allow pinning programs to the Taskbar](javascript:void();)

Enabled

Local Group Policy

[Do not display or track items in Jump Lists from remote locations](javascript:void();)

Enabled

Local Group Policy

[Hide the notification area](javascript:void();)

Enabled

Local Group Policy

[Lock all taskbar settings](javascript:void();)

Enabled

Local Group Policy

[Lock the Taskbar](javascript:void();)

Enabled

Local Group Policy

[Prevent changes to Taskbar and Start Menu Settings](javascript:void();)

Enabled

Local Group Policy

[Prevent users from adding or removing toolbars](javascript:void();)

Enabled

Local Group Policy

[Prevent users from moving taskbar to another screen dock location](javascript:void();)

Enabled

Local Group Policy

[Prevent users from rearranging toolbars](javascript:void();)

Enabled

Local Group Policy

[Prevent users from resizing the taskbar](javascript:void();)

Enabled

Local Group Policy

[Remove access to the context menus for the taskbar](javascript:void();)

Enabled

Local Group Policy

[Remove Default Programs link from the Start menu.](javascript:void();)

Enabled

Local Group Policy

[Remove Favorites menu from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove Games link from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove Help menu from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove links and access to Windows Update](javascript:void();)

Enabled

Local Group Policy

[Remove Music icon from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove Network icon from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove Pictures icon from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove pinned programs from the Taskbar](javascript:void();)

Enabled

Local Group Policy

[Remove pinned programs list from the Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove the Action Center icon](javascript:void();)

Enabled

Local Group Policy

[Remove user folder link from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove user name from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove user's folders from the Start Menu](javascript:void();)

Enabled

Local Group Policy

[Remove Videos link from Start Menu](javascript:void();)

Enabled

Local Group Policy

[Turn off all balloon notifications](javascript:void();)

Enabled

Local Group Policy

[Turn off automatic promotion of notification icons to the taskbar](javascript:void();)

Enabled

Local Group Policy

[Turn off feature advertisement balloon notifications](javascript:void();)
...
[Custom User Interface](javascript:void();)
...
[Remove Change Password](javascript:void();)

Enabled

Local Group Policy

[Remove Lock Computer](javascript:void();)

Enabled

Local Group Policy

[Remove Task Manager](javascript:void();)
...
[Unlock Password](javascript:void();)
...
[Web Interface url](javascript:void();)
...
[Turn off Windows Mail application](javascript:void();)
...
[Remove access to use all Windows Update features](javascript:void();)
