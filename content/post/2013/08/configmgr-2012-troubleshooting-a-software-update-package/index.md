 ...
 *“The source directory \\<servername>\swupd$\workplace\win7upd\10606ddb-3d74-4df9-bf55-0fa26238a7c0 doesn’t exist or the SMS service cannot access it, Win32 last error = 2”*
 ...
 ![image](images/image_thumb12.png) Next i searched foe KB number under the software updates node and deleted the entry within the software update package.  [
![image](images/image_thumb13.png)
](images/image13.png) I then searched for the update within the software update group where it was now marked as an invalid software update but also marked as not being downloaded yet. 
