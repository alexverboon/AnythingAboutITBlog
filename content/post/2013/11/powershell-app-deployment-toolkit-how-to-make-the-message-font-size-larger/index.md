---
title: PowerShell App Deployment Toolkit&ndash; How to make the message  Font size
  larger
layout: post
...
description: I have had a request this week to make the font size of the Message text
