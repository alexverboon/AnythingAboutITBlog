...
![](images/041120_2005_Howtocreate1.png)
...
**#****Description****1**Logon to the **Azure Portal** and go to **Log Analytics workspaces**![](images/041120_2005_Howtocreate2.png)**2**Select **Add **for creating a new Log Analytics workspace
...
- Select the region where you want to deploy the resources, in this example **West US**![](images/041120_2005_Howtocreate3.png)

Click on **Next: Pricing Tier
****3**Select your preferred **Pricing Tier** for Azure Log Analytics

![](images/041120_2005_Howtocreate4.png)
...
![](images/041120_2005_Howtocreate5.png)

Click on **Create**![](images/041120_2005_Howtocreate6.png)**5**Wait until the deployment is complete.

![](images/041120_2005_Howtocreate7.png)
...
**
- **Workspace ID
**![](images/041120_2005_Howtocreate8.png)**7**Select **Advanced Settings**![](images/041120_2005_Howtocreate9.png)
...
**
- **Primary Key
**![](images/041120_2005_Howtocreate10.png)
...
![](images/041120_2005_Howtocreate11.png)

**#****Description****1**Logon to the **Azure Portal** and go to **Logic Apps**![](images/041120_2005_Howtocreate12.png)**2**Select **Add **for creating a new Logic App
...
- Select the region where you want to deploy the resources, in this example **West US**![](images/041120_2005_Howtocreate13.png)

Click **Review + Create
**

Click **Create**![](images/041120_2005_Howtocreate14.png)**3**Wait until the deployment is complete.

![](images/041120_2005_Howtocreate15.png)

Click on **Go to resource****4**Click on **Edit**![](images/041120_2005_Howtocreate16.png)**5**Select **Blank Logic App**![](images/041120_2005_Howtocreate17.png)**6**We want to run this workflow 3 times per day, therefore our **trigger** is a **schedule**.

Search for **Schedule**![](images/041120_2005_Howtocreate18.png)

Select **Recurrence**![](images/041120_2005_Howtocreate19.png)

Enter the **interval**: 8, select the **frequency**: Hour

Then select the **Time zone** and enter the **start time**![](images/041120_2005_Howtocreate20.png)

Now is a good time to save our work before we continue

![](images/041120_2005_Howtocreate21.png)**7**Select **Next Step**![](images/041120_2005_Howtocreate22.png)**8**We want data from Microsoft Defender ATP, search for **Defender **, when found select **Microsoft Defender ATP**![](images/041120_2005_Howtocreate23.png)**9**From the list of **Actions**, select **Actions – Get list of machine actions**![](images/041120_2005_Howtocreate24.png)**10**We now need to sign into Defender ATP, click on the **Sign in** button

![](images/041120_2005_Howtocreate25.png)

Select the account to sign-in, or select use another account

![](images/041120_2005_Howtocreate26.png)**11**We leave the Filter results and parameters empty. Select **Next Step**![](images/041120_2005_Howtocreate27.png)**12**Search for **Control, **then select **For each**![](images/041120_2005_Howtocreate28.png)

Select an output, click into the '**Select an output from previous steps'** field

![](images/041120_2005_Howtocreate29.png)

Select **Machine Actions**![](images/041120_2005_Howtocreate30.png)
...
![](images/041120_2005_Howtocreate31.png)

Select **Add an Action****13**Search for **Log Analytics data collector**![](images/041120_2005_Howtocreate32.png)**14**From the list of **Actions**, select **Send Data** (preview)

![](images/041120_2005_Howtocreate33.png)**15**Remember that when we created the Azure Log Analytics workspace, we noted down some information

![](images/041120_2005_Howtocreate34.png)
...
![](images/041120_2005_Howtocreate35.png)
...
![](images/041120_2005_Howtocreate36.png)**17**Select Add parameter and tick the checkbox for **Time-generated field**![](images/041120_2005_Howtocreate37.png)

Select **utcNow() **,then click **OK**![](images/041120_2005_Howtocreate38.png)![](images/041120_2005_Howtocreate39.png)**18**Our workflow is now complete, now is a good time to save our work again.

![](images/041120_2005_Howtocreate40.png)**19**Next we are going to run our workflow for the very first time, we manually trigger this by clicking on the Run button.

![](images/041120_2005_Howtocreate41.png)
...
![](images/041120_2005_Howtocreate42.png)**20**Our logic app indicates that all actions processed successfully, so let's head over to our Azure Log Analytics workspace and see the results.
...
![](images/041120_2005_Howtocreate43.png)**21**Next, let's take a look at the data ingested by running the following query:
...
![](images/041120_2005_Howtocreate44.png)
...
![](images/041120_2005_Howtocreate45.png)******Machine Actions Summary****MDATPAdminAuditLog_CL **
...
![](images/041120_2005_Howtocreate46.png)******Machine Actions Requestor Summary****MDATPAdminAuditLog_CL **
...
![](images/041120_2005_Howtocreate47.png)******Machine Actions By Date****MDATPAdminAuditLog_CL**
...
![](images/041120_2005_Howtocreate48.png)****
## Creating the workbook

Now that we have our queries prepared, let's move on to the final task and create our MDATP Admin Audit log dashboard.
**#****Description****1**Within the MDATPAdminAuditLog Log Analytics workspace, select **Workbook**![](images/041120_2005_Howtocreate49.png)**2**Select **Default Template**![](images/041120_2005_Howtocreate50.png)**3**Click on the Save Icon and enter the **Title** for the Workbook, then select Save to **Shared Reports, **then click Save.

![](images/041120_2005_Howtocreate51.png)

Now that we have saved our workbook, we can continue editing it. First, we are going to adjust the Workbook Title and description, select **Edit**![](images/041120_2005_Howtocreate52.png)

Change the **title** and a **description**, then click on **Done Editing**![](images/041120_2005_Howtocreate53.png)![](images/041120_2005_Howtocreate54.png)**4**Next, we are going to display the total number of actions triggered within the last 360 days.  Copy the following query into the query field and then select **Run Query
**MDATPAdminAuditLog_CL
...
![](images/041120_2005_Howtocreate55.png)**5**From the **Visualization** drop down menu select **Tiles**![](images/041120_2005_Howtocreate56.png)

Our dashboard is slowly taking shape.

![](images/041120_2005_Howtocreate57.png)

Select **Done Editing****6**Select **Add Query**![](images/041120_2005_Howtocreate58.png)**7**Cop the following query into the query field and set the **visualization** to **Grid, **then select **Run Query**MDATPAdminAuditLog_CL
...
![](images/041120_2005_Howtocreate59.png)

Select **Done Editing****8**Let's add a line between this and the next data section, select **Add Text**![](images/041120_2005_Howtocreate60.png)

Type --- and then click **Done Editing**![](images/041120_2005_Howtocreate61.png)
...
![](images/041120_2005_Howtocreate62.png)
...
![](images/041120_2005_Howtocreate63.png)
...
Set the Visualization to **Time Chart**![](images/041120_2005_Howtocreate64.png)

Select **Done Editing****13**Select **Done Editing** and Save the workbook by selecting the **Save** icon

![](images/041120_2005_Howtocreate65.png)
And there we go, we know have our Microsoft Defender ATP Admin Audit log

![](images/041120_2005_Howtocreate66.png)![](images/041120_2005_Howtocreate67.png)![](images/041120_2005_Howtocreate68.png)
