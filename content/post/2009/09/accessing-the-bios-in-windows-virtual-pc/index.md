...
](images/image1.png)This indicates that the VM is running in **Enhanced** Mode which is the default. To better understand the different modes of Windows Virtual PC I recommend reading the “[Three Modes of Windows XP Mode](http://blogs.technet.com/windows_vpc/archive/2009/08/27/three-modes-of-windows-xp-mode.aspx)” article. 
