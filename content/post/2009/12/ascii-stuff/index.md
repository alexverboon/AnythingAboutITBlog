...
![image](images/image_thumb12.png)If you go to [http://www.network-science.de/ascii/](http://www.network-science.de/ascii/) you can create your own text using the ASCII Generator.

![image](images/image_thumb13.png)Now that we speak about ASCII, during my little search on the web for the above, I also came across another fancy tool called [ASCII Generator .NET](http://ascgendotnet.jmsoftware.co.uk/). The tool allows converting pictures into ASCII Code.

![image](images/image_thumb14.png)* Converted Windows 7 Logo*
