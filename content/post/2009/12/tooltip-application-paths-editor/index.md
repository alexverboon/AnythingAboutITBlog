...
The Application Paths Editor allows you to add, edit and remove Application Paths. Setting an application path for your favorite application or script allows you to run the application directly from the “Run” dialog at the Start Menu. 
  ...
  ![image](images/image_thumb.png) Application Paths are stored in the Windows Registry, so if you are familiar with editing the Registry, you can of course also add Application Paths directly there. 

  ![image](images/image_thumb1.png)  The Application Paths Editor can be downloaded from [here](http://leelusoft.blogspot.com/2009/11/application-paths-editor-10.html)
