...
description: "if you found the previous post [Windows 7 Service Triggers](https://www.verboon.info/index.php/2010/03/windows-7-service-triggers/) interesting, then ..."
author: "Alex Verboon"
image: "img/post-heroes/tooltip-service-trigger-editor.png"
categories:
  - 'Tips-Tools'
tags:
  - 'Freeware'
...
](https://www.verboon.info/wp-content/uploads/2010/03/image19.png) The Tool can be downloaded from [here](http://www.coretechnologies.com/products/ServiceTriggerEditor/) and is ready to run (no installation required)
