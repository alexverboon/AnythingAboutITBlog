...
![image](images/image_thumb8.png) Within the Properties specify Port 1433 as shown in the picture below.

![image](images/image_thumb9.png)Finally restart the SQL Server Service. Once the SQL Service has restarted the App-V Management Server installation Wizard should find the SQL Server Instance.
