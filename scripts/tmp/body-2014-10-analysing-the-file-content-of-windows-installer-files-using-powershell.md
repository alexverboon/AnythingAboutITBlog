...
But then I found [this forum post on stackoverflow](http://stackoverflow.com/questions/17543132/how-can-i-resolve-msi-paths-in-vbscript) discussing how to resolve MSI paths programmatically by calling the [CostInitialize](http://msdn.microsoft.com/en-us/library/aa368050(v=vs.85).aspx) and [CostFinalize](http://msdn.microsoft.com/en-us/library/aa368048(v=vs.85).aspx) Actions. The result of calling these actions is that the full file paths are resolved.
